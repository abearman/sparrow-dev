...
class GPS:
		...
		def ecef2lla(self, ecef, tolerance=1e-9):
				...
				return (rad2deg(lat), rad2deg(lon), -1*alt)  # converts alt to up direction
...
if __name__ == "__main__":
		wgs84 = WGS84()
		gps = GPS()
		lla = (37.43100720000001,
				-122.17314630000001,
				0)
		print "lla: ", lla
		origin_ecef = gps.lla2ecef(lla)
		calculatedEcef = gps.ned2ecef((1,0,0), origin_ecef)
		print "origin: ", origin_ecef
...
def getOrigin(originLLAJSON):
		...
		originLLA = (37.418091, -122.165685, 0)
